...
-- ============================================
local WS_URL = "ws://localhost:3000" -- เปลี่ยนตาม server ของคุณ
...
local function validateDashboardKey()
    if DASHBOARD_KEY == "YOUR_DASHBOARD_KEY" or DASHBOARD_KEY == "" then
        ...
        warn("📝 เปิดไฟล์นี้แล้วแก้ไขบรรทัด: local DASHBOARD_KEY = \"YOUR_DASHBOARD_KEY\"")
...
local function calculateStats(accounts)
    local tm, tf, tb, tsp, tl, aa, ta, ca = 0,0,0,0,0,0,0,0
